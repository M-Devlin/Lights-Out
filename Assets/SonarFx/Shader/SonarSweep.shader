...
Shader "Hidden/SonarSweep"
{
	Properties
	{
		...
		_MidColor ("Middle Color", Color) = (1, 1, 1, 0)
		_TrailColor ("TrailColor", Color) = (1, 1, 1, 0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag(VertOut i) : SV_Target
			{
				...
				float rawDepth = DecodeFloatRG(Tex2D(_CameraDepthTexture, i.uv.depth));
